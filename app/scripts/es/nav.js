(function(){
    ...
    var app = new Vue({
        ...
        data: {
            navMenu: [
                { name: '常用网站', categroy: 'common'},
                { name: '产品中心', categroy: 'pro'},
                { name: '游戏业务', categroy: 'game'},
                { name: '广告业务', categroy: 'ad'},
                { name: '增值业务', categroy: 'inc'}
            ],
            active: 'common',
            commonList: [],
            navList: {}
        ...
        methods: {
            selected: function(categroy) {
                this.active = categroy;
            },
            addCommon: function(item) {
                var ico = '';
                ...
                var index = common.findArrayIndex((v) => {
                    return v.id == item.id;
                })
                if (index !== -1) {
                    common.remove(index);
